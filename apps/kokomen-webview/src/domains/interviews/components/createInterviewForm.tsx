        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-base font-bold">텍스트</span>
            </div>
          </Button>
          <Button
            type="button"
          ...
          >
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-base font-bold">음성</span>
            </div>
          </Button>
        </div>
      </div>
...
const CreateInterviewForm = ({
  ...
  return (
    <form
      className="w-full lg:flex-1 lg:min-w-0 flex flex-col mt-10"
      onSubmit={(e) => {
        e.preventDefault();
        handleNewInterview();
      }}
    >
      ...
      <nav className="w-full mb-8">
        <div className="bg-bg-elevated rounded-2xl p-2 border border-border">
          <div className="flex overflow-x-auto gap-1 p-2 scrollbar-hidden">
