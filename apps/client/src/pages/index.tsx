        ...
        <section className="px-8 py-4">
          ...
          <div className="w-full flex flex-col items-center px-8">
            ...
            <p className="py-4 text-lg">
              ...
              관리하고, 사용자 및 응용 프로그램이 컴퓨터와 상호작용할 수 있도록
              지원하는 소프트웨어의 집합이라고 정의할 수 있습니다. 기본적으로,
              운영체제는 컴퓨터 시스템의 자원을 효율적으로 관리하고, 사용자 및
              다른 소프트웨어와의 상호작용을 가능하게 하여, 사용자가
              소프트웨어를 더 쉽게 사용할 수 있게 돕습니다. 운영체제의 주요
              목표는 시스템의 성능을 최적화하면서, 사용자에게 편리한
              인터페이스를 제공하는 것입니다.
            </p>
            <button
