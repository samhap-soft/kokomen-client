...
# 이미지가 "/kokomen-client-prod:production"이 되고 invalid reference format으로 죽는다.
...
echo "========================================="
echo " Blue-Green Deploy: Prod (Traefik)"
echo "========================================="
...
# ---------------------------------------------------------------------------
# 2. 현재 활성 색상 판별 (라이브 라우팅 파일이 유일한 진실)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 4. 새 색상 컨테이너 기동 (라우터가 가리키지 않으므로 트래픽 0)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 5. 트래픽 전환 — 리포의 client.yaml을 새 색상으로 렌더해서 원자적으로 교체
